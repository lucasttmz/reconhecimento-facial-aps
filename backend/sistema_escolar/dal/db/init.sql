...
VALUES
    (NULL, 'J04FE4A7', 'Joaquim', 1),
    (NULL, 'B7B4A706', 'Raquel', 2),
    (NULL, 'F74CDC5E', 'Felipe', 1),
    (NULL, 'P478D1AE', 'Pedro', 3),
    (NULL, 'Z7396D97', 'Zézão', 1),
    (NULL, 'Z363D42D', 'Zézinho', 1),
    (NULL, 'J0BFE4A7', 'Joaquim', 1),
    (NULL, 'R4B4A706', 'Raquel', 2),
    (NULL, 'F34CDC5E', 'Felipe', 1),
    (NULL, 'C568D1AE', 'César', 3),
    (NULL, 'J4BFE4A7', 'Jaqueline', 1),
    (NULL, 'L0B4A706', 'Lorena', 2),
    (NULL, 'M54CDC5E', 'Moura', 1),
    (NULL, 'J478D1AE', 'Jean', 3),
